...
export const PostSnapshot = (projectName, {snapshot, opticVersion, branch, commitName, published}, team) =>
	authenticated({qs: {team}, json: {snapshot, opticVersion, branch, commitName, published}}).then(options =>
