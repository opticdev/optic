...
class UploadOAS extends React.Component {
    ...
    processSpec = async (contents) => {
        ...
        if (response.status === 200) {
            ...
            this.setState({
                fileUploaded: false,
                error: 'Error parsing OAS file. Please make sure it is valid and try again'
            })
        }
    }
        ...
        return <div className={classes.root}>
            ...
            <Paper elevation={2} className={classes.uploadCenter}>
                ...
                <Typography variant="overline" color="primary"
                            style={{lineHeight: 1.4, fontSize: 20, marginBottom: 11}}>Import an existing API
                ...
                {!fileUploaded ? (
                    ...
                    <>
                        <Typography variant="body1" style={{color: '#27794e'}}>Spec Selected.
                            Processing...!</Typography>
                        <Typography variant="caption" style={{color: '#49525f'}}>This will take a few
                            seconds</Typography>
