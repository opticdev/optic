...
const Quotes = [
  {
    ...
    "quote": "Optic is a smart, simple, and straightforward solution to a real world problem every company faces.",
    "pic": "/people/kinface.jpg"
  },
  {
    "name": "Zdenek Nemec",
    "title": "FOUNDER GOOD API\nCREATOR OF API BLUEPRINT",
    "quote": "Traffic-driven API development and ops is the the future of handling the skyrocketing complexity of API landscapes. Thats is why I am really excited to see efforts like Optic.",
...
export function ApiDemo() {
  ...
  return (
    <Container maxWidth="lg" className={classes.gitBotContainer} style={{marginBottom: 120}}>
      <Grid container xs={12}>
        <Grid xs={12} md={6} item className={classes.spacingRightLarge}>

          <Typography variant="subtitle2" style={{fontFamily: 'Ubuntu Mono', fontWeight: 800, marginBottom: 14}} component="div">
            API CLI makes documenting endpoints and detecting changes easy
          </Typography>

          <Paper elevation={4} style={{overflow: 'hidden', maxHeight: 350 }}>
            <img src="../../static/img/status.svg"/>
          </Paper>
        ...
        <Grid xs={12} md={6} item className={classes.spacingTopLarge}>
          ...
          <Paper elevation={4} style={{overflow: 'hidden', maxHeight: 350}}>
            <img src="../../static/img/big-diff.png"/>
          </Paper>
    ...
    <Container maxWidth={false} className={classes.gitBotContainer}>
      <Container maxWidth="md">
        ...
        <Typography variant="subtitle2" className={featuredStyles.descriptions}>
          ...
          <Typography variant="subtitle2" component="div" style={{marginTop: 20}}>our project is built around core principles: </Typography>
          <ul style={{marginTop: 15}}>
            <li>Working with API specifications should be developer-friendly & accessible to everyone</li>
            <li>Documenting new endpoints should feel like Git-adding a file</li>
            <li>Every API change should be easy to document and review in Pull Requests</li>
          </ul>
        </Typography>
