...
<Typography variant="h6" color="textPrimary" style={{marginBottom: 2}}>🚀 Let's make APIs friendly and more accessible for all everyone</Typography>
...
- What if API changes could easily be listed and discussed during Code Reviews?
- What if API consumers got notified about upcoming changes ***before*** they happened?

<span style={{color: '#605f5f'}}>^ If you get excited about making this real, we want to meet</span>

</Paper>


## Roles
We see recruiting as an exercise in world-building. We are creating our own slice of the universe where the cast of characters work together to overcome challenges, support one another's growth, and lead compelling lives. We’re building an organization we are proud of and eager to spend most of our working hours each day.
