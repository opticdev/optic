...
Optic is easy to use with Express JS, no special library or large code changes required.

## `api start` Command

Let's say we have a simple Express JS server that we usually develop with on localhost:3005.
