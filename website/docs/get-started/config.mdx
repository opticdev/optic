...
api init
```
This will start a guided setup flow. After a few brief questions about your API, the Optic dashboard will open in your browser on a setup page. From here, the dashboard will guide you through common integrations for your project:

![API Init dashboard helps integrate your project with Optic](../../static/img/tutorial.png)

The task aliases created in this process are stored in `optic.yml`. For example, a basic Node project might look like this:
```yaml
name: "My API"
tasks:
  start:
