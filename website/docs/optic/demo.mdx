...
<IFrameDemoNotCentered url={'https://demo.useoptic.com/demos/github/review'} />
...
<IFrameDemoNotCentered url={'https://demo.useoptic.com/demos/github-with-diffs/review'} />
...
**And install the Optic GitBot** -- it makes API changes explicit during Code Review, so your team understands how the API will change when the PR is merged.
...
Look cool? Want to give it a try? **[Add Optic with your API](/docs/)**

**Schedule a call with the maintainers if you want help setting up the advanced features**
