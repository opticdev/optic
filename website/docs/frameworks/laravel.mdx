---
title: Laravel
productboard_url: 'https://portal.productboard.com/useoptic/3-integrations-board/c/26-laravel'
start_command: 'php artisan serve --port=$PORT'
icon: '/img/langs/laravel.png'
---
...
No code changes should be needed - by pasisng in the port with the command, you're ready to go!
