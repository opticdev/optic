---
title: Django
productboard_url: 'https://portal.productboard.com/useoptic/3-integrations-board/c/20-django'
start_command: 'python manage.py runserver'
icon: '/img/langs/django.ico'
---
...
def main():
    ...
    try:
        ...
        runserver.default_port = os.environ['PORT'] if 'PORT' in os.environ else 4000
```
