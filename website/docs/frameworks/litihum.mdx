---
title: Lithium
productboard_url: 'https://portal.productboard.com/useoptic/3-integrations-board/c/25-lithium'
start_command: 'li run ./main.cc'
icon: '/img/langs/lithium.png'
---
