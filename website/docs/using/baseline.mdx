...
If you've inadvertently added an endpoint to your documentation which you don't want, you can remove it from the Docs page. Click on Edit in the upper-right hand corner, which will reveal trash can icons after each endpoint. You may enqueue multiple endpoints for delete, though if you have multiple changes to make, you may want to consider if [reverting changes](#reverting-changes) may work in your case. You can change your mind up until you click Save to commit these deletes to your documentation:

![Deleting an endpoint with the trash can icon.](../../static/img/docs/delete-endpoint.png)

### Reverting changes
 
 The History page shows you the history of your documentation, with commit messages for all of your learning sessions. You can compare your documentation to any point in history, and if necessary, revert to a previous change. Reverting is a one-way decision: once done, it cannot be undone.

![The history tab shows your documentation commits and allows you to revert changes](../../static/img/docs/history-tab.png)