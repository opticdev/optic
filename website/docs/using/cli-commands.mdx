...
Optionally, `api init` can take parameters to pre-populate your configuration. While we wouldn't recommend users learn these flags, we may provide you with an init command including some of these parameters to help you get started:
