...
This endpoint has been removed from Optic 10.1 in favor of a full-featured endpoint delete within the Optic documentation dashboard. If you have to delete an endpoint, we strongly encourage you to update to Optic 10.1 and use the latest [delete feature](/docs/using/baseline#deleting-endpoints).
