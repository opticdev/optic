...
import com.seamless.changelog.Changelog.{AddedRequest, AddedResponse, Change, FieldShapeChange, ListItemTypeChanged, NewField, RemovedField, ShapeChange}
...
import com.seamless.ddd.CachedProjection
