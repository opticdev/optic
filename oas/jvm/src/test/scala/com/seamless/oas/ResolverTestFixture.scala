...
class ResolverTestFixture(version: String) extends FunSpec {
  ...
  //oas2
  val mattermost = pathToJSON("jvm/src/test/resources/mattermost-2.json")
  val adverseSchemas = pathToJSON("jvm/src/test/resources/adverse-json-schemas-2.json")
  val oxfordDictionary = pathToJSON("jvm/src/test/resources/oxforddictionaries.com.json")
  //oas3
  val bbc = pathToJSON("jvm/src/test/resources/bbc-3.json")
  val box = pathToJSON("jvm/src/test/resources/box-3.json")
