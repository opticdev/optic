...
class OASExportSpec extends FunSpec {
  ...
  lazy val a = loadRfcServiceFromEvents("js/src/test/scala/com/seamless/oas/export/github-events.json")
  lazy val p = loadRfcServiceFromEvents("js/src/test/scala/com/seamless/oas/export/pagination.json")
