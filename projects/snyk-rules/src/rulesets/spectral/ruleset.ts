// This document is generated using https://www.npmjs.com/package/@stoplight/spectral-ruleset-migrator
// And was modified to work with TypeScript
...
export default {
    ...
    [oas, "all"],
    {
      rules: {
        "jsonapi-response-content-type": {
          ...
          severity: "error",
          given:
            "$.paths[?(!@property.match(/\\/(openapi|sarif)(\\/.*)?$/))][*].responses[*].content",
          then: {
        ...
        "jsonapi-get-post-response-data": {
          ...
          severity: "error",
          given:
            "$.paths[?(!@property.match(/\\/openapi/))][?(@property.match(/get|post/))].responses[?(@property.match(/200|201/))].content['application/vnd.api+json']",
          then: {
        ...
        "jsonapi-response-jsonapi": {
          ...
          severity: "error",
          given:
            "$.paths[?(!@property.match(/\\/openapi/))][?(!@property.match(/patch|delete/))].responses[?(@property.match(/200|201/))].content['application/vnd.api+json']",
          then: {
            function: assertObjectPath,
            functionOptions: {
        ...
        "jsonapi-get-post-response-data-schema": {
          ...
          severity: "error",
          given:
            "$.paths[?(!@property.match(/\\/openapi/))][?(@property.match(/get|post/))].responses[?(@property.match(/200|201/))].content['application/vnd.api+json'].schema.properties",
          then: {
            field: "data",
            function: schema,
            functionOptions: {
        ...
        "jsonapi-patch-response-data": {
          ...
          severity: "error",
          given:
            "$.paths[?(!@property.match(/\\/openapi/))].patch.responses.200",
          then: {
            function: assertObjectPath,
            functionOptions: {
              path: [
        ...
        "jsonapi-patch-response-200-schema": {
          ...
          severity: "error",
          given:
            "$.paths[?(!@property.match(/\\/openapi/))].patch.responses.200.content['application/vnd.api+json'].schema",
          then: {
            field: "properties",
            function: schema,
            functionOptions: {
        ...
        "jsonapi-patch-response-204-schema": {
          ...
          severity: "error",
          given:
            "$.paths[?(!@property.match(/\\/openapi/))].patch.responses.204",
          then: {
            field: "content",
            function: falsy,
          },
        ...
        "jsonapi-created-response-location": {
          description:
            "Post responses must include a location header for the created resource",
          severity: "error",
        ...
        "jsonapi-created-response-self-link": {
          description:
            "Post responses must include a self link for the created resource",
          severity: "error",
          given:
            "$.paths[*].post.responses.201.content['application/vnd.api+json'].schema.properties.data.properties.links.properties",
          then: {
            field: "self",
            function: truthy,
          },
        ...
        "jsonapi-delete-response-200": {
          ...
          severity: "error",
          given:
            "$.paths[?(!@property.match(/\\/openapi/))].delete.responses.200.content['application/vnd.api+json'].schema",
          then: {
            field: "properties",
            function: schema,
            functionOptions: {
        ...
        "jsonapi-delete-response-204": {
          ...
          severity: "error",
          given:
            "$.paths[?(!@property.match(/\\/openapi/))].delete.responses.204",
          then: {
            field: "content",
            function: falsy,
          },
        ...
        "jsonapi-content-non-204": {
          ...
          severity: "error",
          given:
            "$.paths[?(!@property.match(/\\/openapi/))][*].responses[?(@property !== '204')]",
          then: {
            field: "content",
            function: truthy,
          },
        ...
        "jsonapi-pagination-collection-parameters": {
          ...
          severity: "error",
          given:
            "$.paths[?(!@property.match(/\\/openapi/) && !@property.match(/\\{[a-z]*?_?id\\}$/))].get.parameters",
          then: {
            function: contains,
            functionOptions: {
              field: "name",
        ...
        "jsonapi-pagination-collection-links": {
          ...
          severity: "error",
          given:
            "$.paths[?(!@property.match(/\\/openapi/) && !@property.match(/\\{[a-z]*?_?id\\}$/))].get.responses.200.content['application/vnd.api+json'].schema.properties",
          then: {
            field: "links",
            function: truthy,
          },
        ...
        "jsonapi-no-pagination-parameters": {
          description:
            "Non-GET requests should not allow pagination parameters",
          severity: "error",
          given:
            "$.paths[*][?(@property.match(/post|patch|delete/))].parameters",
          then: {
        ...
        "jsonapi-self-links-get-patch": {
          description:
            "Successful GET responses should include a top-level self link",
          severity: "error",
          given:
            "$.paths[?(!@property.match(/\\/openapi/))][?(@property.match(/get|patch/))].responses.200.content['application/vnd.api+json'].schema.properties",
          then: {
            function: assertObjectPath,
            functionOptions: {
        ...
        "jsonapi-self-links-post": {
          ...
          severity: "error",
          given:
            "$.paths[?(!@property.match(/\\/openapi/))].post.responses.201.content['application/vnd.api+json'].schema.properties",
          then: {
            function: assertObjectPath,
            functionOptions: {
              path: ["links", "properties", "self"],
        ...
        "jsonapi-response-relationship-schema": {
          ...
          severity: "error",
          given:
            "$.paths.*.*.responses.*.content['application/vnd.api+json'].schema.properties.data.properties.relationships",
          then: {
            function: schema,
            functionOptions: {
              schema: {
        ...
        "jsonapi-no-compound-documents": {
          ...
          severity: "error",
          given:
            "$.paths.*.*.responses[?(@property.match(/200|201/))].content['application/vnd.api+json'].schema.properties",
          then: {
            field: "included",
            function: falsy,
          },
    ...
    },
    {
      rules: {
        ...
        "component-response-names": {
          ...
          severity: "error",
          given:
            "$..components[?(@property === 'responses')][?(!@property.match(/^\\d+$/))]~",
          then: {
            field: "@key",
            function: casing,
            functionOptions: {
  ...
  rules: {
    ...
    "apinext-route-tenant-uuids": {
      description:
        "APIs must use UUIDs where org or group tenants are specified",
      severity: "error",
      given:
        "$.paths[*][*].parameters[?(@.name.match(/org_id|group_id/))].schema",
      then: [
        {
          field: "type",
    ...
    "apinext-operation-response-array-examples": {
      ...
      severity: "error",
      given:
        "$.paths[*][*].responses[*].content[*].schema.properties.data.items.properties.attributes..[properties][?(!@.type.match(/object|boolean/))]",
      then: {
        function: xor,
        functionOptions: {
    ...
    "apinext-operation-response-single-examples": {
      ...
      severity: "error",
      given:
        "$.paths[*][*].responses[*].content[*].schema.properties.data.properties.attributes..[properties][?(!@.type.match(/object|boolean/))]",
      then: {
        function: xor,
        functionOptions: {
          properties: ["enum", "example"],
    ...
    "apinext-date-property-formatting": {
      ...
      severity: "error",
      given:
        "$.paths[*][*].responses[*].content[*].schema..properties[?(@property.match(/created|updated|deleted/))]",
      then: [
        {
          field: "format",
          function: equals,
