...
export namespace FlatOpenAPI {
  // FlatOpenAPI extensions can be declared using generics
  // e.g.:
  // FlatOpenAPI.Document<{
...
export namespace FlatOpenAPIV3_1 {
  ...
  export type HttpMethods = FlatOpenAPIV3.HttpMethods;
...
export namespace FlatOpenAPIV3 {
  ...
  // All HTTP methods allowed by FlatOpenAPI 3 spec
  // See https://swagger.io/specification/#path-item-object
  // You can use keys or values from it in TypeScript code like this:
  //     for (const method of Object.values(FlatOpenAPIV3.HttpMethods)) { … }
  ...
  export interface BaseSchemaObject {
    // JSON schema allowed properties, adjusted for FlatOpenAPI
    title?: string;
    description?: string;
    format?: string;
    default?: any;
    ...
    // FlatOpenAPI-specific properties
    nullable?: boolean;
    discriminator?: DiscriminatorObject;
    readOnly?: boolean;
    writeOnly?: boolean;
...
export namespace FlatOpenAPIV2 {
  ...
  // All HTTP methods allowed by FlatOpenAPI 2 spec
  // See https://swagger.io/specification/v2#path-item-object
  // You can use keys or values from it in TypeScript code like this:
  //     for (const method of Object.values(FlatOpenAPIV2.HttpMethods)) { … }
  export enum HttpMethods {
    GET = 'get',
    PUT = 'put',
    POST = 'post',
