...
export default class Run extends Command {
  static description = 'run your API process with Optic monitoring, given a capture configuration generated by optic-ci';

  static examples = [`$ optic-agent run --command="npm start" --config=$CAPTURE_CONFIG --listen=http://localhost:3001`];
