...
@useoptic/ci-cli/8.3.3 darwin-x64 node-v12.4.0
...
_See code: [src/commands/capture/start.ts](https://github.com/useoptic/optic-package/blob/v8.3.3/src/commands/capture/start.ts)_
