...
package object sourcegear {
  ...
  case class FileParseResults(astGraph: AstGraph, modelNodes: Vector[ModelNode], parser: ParserBase, fileContents: String, fileNameAnnotationOption: Option[FileNameAnnotation])
