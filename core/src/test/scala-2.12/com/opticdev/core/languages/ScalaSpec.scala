...
class ScalaSpec extends TestBase with GearUtils with BeforeAndAfterAll {
  ...
  lazy val scalaPackage = OpticPackage.fromString("{\"info\":{\"author\":\"optic\",\"package\":\"scala-test\",\"version\":\"0.1.0\",\"range\":{\"start\":0,\"end\":81}},\"schemas\":[],\"lenses\":[{\"name\":\"example-scala\",\"id\":\"example-scala\",\"snippet\":{\"block\":\"val hello = world\\n\",\"language\":\"es7\"},\"value\":{\"value\":{\"type\":\"token\",\"at\":{\"astType\":\"Term.Name\",\"range\":{\"start\":12,\"end\":17}}},\"definedAs\":{\"type\":\"token\",\"at\":{\"astType\":\"Term.Name\",\"range\":{\"start\":4,\"end\":9}}}},\"variables\":{},\"containers\":{},\"schema\":{\"type\":\"object\",\"properties\":{\"value\":{\"type\":\"string\"},\"definedAs\":{\"type\":\"string\"}}},\"initialValue\":{},\"internal\":false,\"range\":{\"start\":141,\"end\":577}}],\"transformations\":[]}").get.resolved(Map())
