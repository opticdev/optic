...
class ContainerSpec extends AkkaTestFixture("ContainerSpec") with ParserUtils with GearUtils {
  ...
  describe("Subcontainers") {
    ...
    describe("schema mapping") {
      ...
      implicit lazy val sourceGearContext = SGContext(sourceGear.fileAccumulator, result.get.astGraph, SourceParserManager.installedParsers.head, null, sourceGear, null, null, null)
