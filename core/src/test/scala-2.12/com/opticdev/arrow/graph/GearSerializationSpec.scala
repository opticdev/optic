...
class GearSerializationSpec extends TestBase with TestPackageProviders {
  ...
  it("can serialize a basic graph") {
    ...
    assert(result == Json.parse("""{"nodes":[{"id":"optic:express-js@0.1.0/route","name":"Route","packageFull":"optic:express-js@0.1.0","type":"gear"},{"id":"optic:rest@0.1.0/parameter","name":"Parameter","packageFull":"optic:rest@0.1.0","type":"schema"},{"id":"optic:express-js@0.1.0/response","name":"Response","packageFull":"optic:express-js@0.1.0","type":"gear"},{"id":"optic:rest@0.1.0/route","name":"Route","packageFull":"optic:rest@0.1.0","type":"schema"},{"id":"optic:rest@0.1.0/response","name":"Response","packageFull":"optic:rest@0.1.0","type":"schema"},{"id":"optic:express-js@0.1.0/parameter","name":"Parameter","packageFull":"optic:express-js@0.1.0","type":"gear"}],"edges":[{"n1":"optic:rest@0.1.0/parameter","n2":"optic:express-js@0.1.0/parameter"},{"n1":"optic:rest@0.1.0/route","n2":"optic:express-js@0.1.0/route"},{"n1":"optic:rest@0.1.0/response","n2":"optic:express-js@0.1.0/response"}]}"""))
  }
