package com.useoptic.document

import scala.meta.Type
import com.useoptic.document.ReadCaseClasses.fileContents
import com.useoptic.document.domain_docs.{Commands, Events}
...
object DocBuilder {
  def main(args: Array[String]): Unit = {
    val contents = fileContents("src/test/scala/com/useoptic/document/domain_docs/spec.md")
